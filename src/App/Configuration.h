...
namespace App {
  ...
  class Configuration_ {
    ...
    private:
      ...
      static constexpr const char *kNvsTimeDaylightOffset = "tme.dst.offset";
      static constexpr const char *kNvsTimeZoneLabel = "tme.tz.label";
      static constexpr const char *kNvsTimeLowPowerSyncEnable = "tme.rare.en";
      static constexpr const char *kNvsTimeLowPowerSyncIntervalSec = "tme.rare.int";
      static constexpr const char *kNvsTimeLastSuccessfulSyncEpochUtc = "tme.last.utc";
      ...
      static constexpr const char *kNvsConFallbackApSsid = "con.fap.ssid";
      static constexpr const char *kNvsConFallbackApPass = "con.fap.pass";
      static constexpr const char *kNvsConFallbackApIp = "con.fap.ip";
      static constexpr const char *kNvsConFallbackApGw = "con.fap.gw";
      static constexpr const char *kNvsConFallbackApSubnet = "con.fap.sub";
      static constexpr const char *kNvsConStaSsid = "con.sta.ssid";
      static constexpr const char *kNvsConStaPass = "con.sta.pass";
      static constexpr const char *kNvsConStaAutoFallbackApEnable = "con.sta.afap";
      static constexpr const char *kNvsConStaConnectMaxRetry = "con.sta.mxrt";
      static constexpr const char *kNvsConStaRetryDelayMs = "con.sta.rtd";
      ...
      static constexpr const char *kNvsStgDefaultFs = "stg.dfs";
      static constexpr const char *kNvsStgFallback = "stg.fallback";
      static constexpr const char *kNvsDashUser = "dsh.user";
      static constexpr const char *kNvsDashPassword = "dsh.password";
      static constexpr const char *kNvsDashLanguage = "dsh.lang";
